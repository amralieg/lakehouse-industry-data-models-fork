...
def create_app(
    *,
    ...
    # PLAN #53 — request-id correlation must wrap every other middleware
    # so the ContextVar is set before any handler / dependency runs.
    ...
    from ..error_sanitization import register_error_handlers
